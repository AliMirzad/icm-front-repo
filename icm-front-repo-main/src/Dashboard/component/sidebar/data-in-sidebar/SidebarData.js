import {
  ...
  export const SidebarData = [
    ...
    {
      icon: UilUsersAlt,
      heading: "مدیریت شرکت ها",
      link: "/dashboard/Management",
    },
    {
      icon: UilPackage,
      heading: "مدیریت نمایندگان شرکت ها",
      link: "/dashboard/ManageUserCompany",
    },
    {
      icon: UilChart,
      heading: "مدیریت اطلاعات پایه",
      link: "/dashboard/infomanagement",
    },
    {
      icon: UilChart,
      heading: "ایجاد سایت",
      link: "/dashboard/createsite",
    },
    {
      icon: UilChart,
      heading: "پشتیبانی",
